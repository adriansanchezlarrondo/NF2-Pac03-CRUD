...
<div class="container">
    ...
    <button type="button" style="margin: 10px 0; display:none" id="borrarFila">Borrar</button>
    <button type='button' style="margin: 10px 0; display:none" id='submitUpdateBtn'>Actualizar</button>
...
<script>
    document.getElementById("searchForm").addEventListener("submit", function(e) {
        ...
        var actualizar = document.getElementById("submitUpdateBtn");
    ...
    document.getElementById("submitUpdateBtn").addEventListener("click", function() {
        ...
        var esconder = document.getElementById("submitUpdateBtn");
        var comando = document.getElementById("comando").value
